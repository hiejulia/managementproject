...
@Table(name = "supplier", catalog = "erp_sales")
public class Supplier implements java.io.Serializable {

    // Supplier : id, name, street, city, country, zip, tel, fax, email
    private Integer id;
    private String name;
    ...
    public Supplier(String name, String street, String city, String country,
